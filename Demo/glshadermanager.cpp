...
/**
 * @brief GLShaderManager::InitializeStockShaders
 * Initialize and load the stock shaders
 * @return
 */
bool GLShaderManager::InitializeStockShaders()
{
    uiStockShaders[GLT_SHADER_IDENTITY]			= GLTools::gltLoadShaderPairSrcWithAttributes(szIdentityShaderVP, szIdentityShaderFP, 1, GLT_ATTRIBUTE_VERTEX, "vVertex");
    uiStockShaders[GLT_SHADER_FLAT]				= GLTools::gltLoadShaderPairSrcWithAttributes(szFlatShaderVP, szFlatShaderFP, 1, GLT_ATTRIBUTE_VERTEX, "vVertex");
    uiStockShaders[GLT_SHADER_SHADED]			= GLTools::gltLoadShaderPairSrcWithAttributes(szShadedVP, szShadedFP, 2,
                                                                                                GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_COLOR, "vColor");


    uiStockShaders[GLT_SHADER_DEFAULT_LIGHT]	= GLTools::gltLoadShaderPairSrcWithAttributes(szDefaultLightVP, szDefaultLightFP, 2,
                                                                                                GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal");

    uiStockShaders[GLT_SHADER_POINT_LIGHT_DIFF] = GLTools::gltLoadShaderPairSrcWithAttributes(szPointLightDiffVP, szPointLightDiffFP, 2,
                                                                                                GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal");

    uiStockShaders[GLT_SHADER_TEXTURE_REPLACE]  = GLTools::gltLoadShaderPairSrcWithAttributes(szTextureReplaceVP, szTextureReplaceFP, 2,
                                                                                                GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");

    uiStockShaders[GLT_SHADER_TEXTURE_MODULATE] = GLTools::gltLoadShaderPairSrcWithAttributes(szTextureModulateVP, szTextureModulateFP, 2,
                                                        GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");

    uiStockShaders[GLT_SHADER_TEXTURE_POINT_LIGHT_DIFF] = GLTools::gltLoadShaderPairSrcWithAttributes(szTexturePointLightDiffVP, szTexturePointLightDiffFP, 3,
                                                                GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");


    uiStockShaders[GLT_SHADER_TEXTURE_RECT_REPLACE] = GLTools::gltLoadShaderPairSrcWithAttributes(szTextureRectReplaceVP, szTextureRectReplaceFP, 2,
                                                                                             GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoord0");
...
/**
 * @brief GLShaderManager::GetStockShader
...
/**
 * @brief GLShaderManager::UseStockShader
...
/**
 * @brief GLShaderManager::LoadShaderPair
...
/**
 * @brief GLShaderManager::LoadShaderPairSrc
...
/**
 * @brief GLShaderManager::LoadShaderPairWithAttributes
...
/**
 * @brief GLShaderManager::LoadShaderPairSrcWithAttributes
...
/**
 * @brief GLShaderManager::LookupShader
