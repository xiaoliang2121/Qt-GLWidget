#ifndef GLTRIANGLEBATCH_H
#define GLTRIANGLEBATCH_H
...
class GLTriangleBatch : public GLBatchBase, protected QOpenGLFunctions_3_3_Compatibility
{
public:
    GLTriangleBatch();
    virtual ~GLTriangleBatch();
