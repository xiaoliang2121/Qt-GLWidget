...
/**
 * @brief GLTools::gltGetOpenGLVersion Get the OpenGL version number
 * @param nMajor
 * @param nMinor
 */
void GLTools::gltGetOpenGLVersion(GLint &nMajor, GLint &nMinor)
{
#ifndef OPENGL_ES
...
/**
 * @brief GLTools::gltIsExtSupported This function determines if the named OpenGL
 * Extension is supported
 * @param szExtension
 * @return 1 or 0
 */
int GLTools::gltIsExtSupported(const char *szExtension)
{
#ifndef OPENGL_ES
...
/**
 * @brief GLTools::gltSetWorkingDirectory
 * No-op on anything other than the Mac, sets the working directory to
 * the /Resources folder
 * @param szArgv
 */
void GLTools::gltSetWorkingDirectory(const char *szArgv)
{
#ifdef __APPLE__
...
/**
 * @brief GLTools::gltReadBMPBits
 * @param szFileName
 * @param nWidth
 * @param nHeight
 * @return
 */
GLbyte *GLTools::gltReadBMPBits(const char *szFileName, int *nWidth, int *nHeight)
{
    FILE*	pFile;
 ...
 * @return
 */
GLbyte *GLTools::gltReadTGABits(const char *szFileName, GLint *iWidth, GLint *iHeight, GLint *iComponents, GLenum *eFormat)
{
...
#ifndef OPENGL_ES
/**
 * @brief GLTools::gltGrabScreenTGA
 ...
 * @return
 */
GLint GLTools::gltGrabScreenTGA(const char *szFileName)
{
    FILE *pFile;                // File pointer
    TGAHEADER tgaHeader;		// TGA file header
    unsigned long lImageSize;   // Size in bytes of image
 ...
 * @param numMinor
 */
void GLTools::gltMakeTorus(GLTriangleBatch &torusBatch, GLfloat majorRadius, GLfloat minorRadius, GLint numMajor, GLint numMinor)
{
...
/**
 * @brief GLTools::gltMakeSphere Make a sphere
 * @param sphereBatch
 * @param fRadius
 * @param iSlices
 * @param iStacks
 */
void GLTools::gltMakeSphere(GLTriangleBatch &sphereBatch, GLfloat fRadius, GLint iSlices, GLint iStacks)
{
 ...
 * @param nStacks
 */
void GLTools::gltMakeDisk(GLTriangleBatch &diskBatch, GLfloat innerRadius, GLfloat outerRadius, GLint nSlices, GLint nStacks)
{
...
/**
 * @brief GLTools::gltMakeCylinder Draw a cylinder. Much like gluCylinder
 * @param cylinderBatch
 * @param baseRadius
 * @param topRadius
 * @param fLength
 ...
 * @param numStacks
 */
void GLTools::gltMakeCylinder(GLTriangleBatch &cylinderBatch, GLfloat baseRadius, GLfloat topRadius, GLfloat fLength, GLint numSlices, GLint numStacks)
{
...
/**
 * @brief GLTools::gltMakeCube
 * Make a cube, centered at the origin, and with a specified "radius"
 * @param cubeBatch
 * @param fRadius
 */
void GLTools::gltMakeCube(GLBatch &cubeBatch, GLfloat fRadius)
{
...
/**
 * @brief GLTools::gltLoadShaderSrc
...
/**
 * @brief GLTools::gltLoadShaderFile
...
/**
 * @brief GLTools::gltLoadShaderPair
...
/**
 * @brief GLTools::gltLoadShaderPairWithAttributes
 * Load a pair of shaders, compile, and link together. Specify the complete
...
/**
 * @brief GLTools::gltLoadShaderPairSrc
 * Load a pair of shaders, compile, and link together. Specify the complete
 * file path for each shader. Note, there is no support for
 * just loading say a vertex program... you have to do both.
 * @param szVertexSrc
...
/**
 * @brief GLTools::gltLoadShaderPairSrcWithAttributes
 * Load a pair of shaders, compile, and link together. Specify the complete
...
/**
 * @brief GLTools::gltGenerateOrtho2DMat
 * Create a matrix that maps geometry to the screen.
 * 1 unit in the x directionequals one pixel
 ...
 * @param screenQuad
 */
void GLTools::gltGenerateOrtho2DMat(GLuint width, GLuint height, M3DMatrix44f &orthoMatrix, GLBatch &screenQuad)
{
...
{
    GLTools::gltGetOpenGLVersion(nMajor,nMinor);
}

int gltIsExtSupported(const char *szExtension)
{
    return GLTools::gltIsExtSupported(szExtension);
}

void gltSetWorkingDirectory(const char *szArgv)
{
    GLTools::gltSetWorkingDirectory(szArgv);
}

GLbyte *gltReadBMPBits(const char *szFileName, int *nWidth, int *nHeight)
{
    return GLTools::gltReadBMPBits(szFileName,nWidth,nHeight);
}

GLbyte *gltReadTGABits(const char *szFileName, GLint *iWidth, GLint *iHeight, GLint *iComponents, GLenum *eFormat)
{
    return GLTools::gltReadTGABits(szFileName,iWidth,iHeight,iComponents,eFormat);
}

GLint gltGrabScreenTGA(const char *szFileName)
{
    return GLTools::gltGrabScreenTGA(szFileName);
}

void gltMakeTorus(GLTriangleBatch &torusBatch, GLfloat majorRadius, GLfloat minorRadius, GLint numMajor, GLint numMinor)
{
    GLTools::gltMakeTorus(torusBatch,majorRadius,minorRadius,numMajor,numMinor);
}

void gltMakeSphere(GLTriangleBatch &sphereBatch, GLfloat fRadius, GLint iSlices, GLint iStacks)
{
    GLTools::gltMakeSphere(sphereBatch,fRadius,iSlices,iStacks);
}

void gltMakeDisk(GLTriangleBatch &diskBatch, GLfloat innerRadius, GLfloat outerRadius, GLint nSlices, GLint nStacks)
{
    GLTools::gltMakeDisk(diskBatch,innerRadius,outerRadius,nSlices,nStacks);
}

void gltMakeCylinder(GLTriangleBatch &cylinderBatch, GLfloat baseRadius, GLfloat topRadius, GLfloat fLength, GLint numSlices, GLint numStacks)
{
    GLTools::gltMakeCylinder(cylinderBatch,baseRadius,topRadius,fLength,
                             numSlices,numStacks);
}

void gltMakeCube(GLBatch &cubeBatch, GLfloat fRadius)
{
    GLTools::gltMakeCube(cubeBatch,fRadius);
}

void gltLoadShaderSrc(const char *szShaderSrc, GLuint shader)
{
    GLTools::gltLoadShaderSrc(szShaderSrc,shader);
}

bool gltLoadShaderFile(const char *szFile, GLuint shader)
{
    GLTools::gltLoadShaderFile(szFile,shader);
}

GLuint gltLoadShaderPair(const char *szVertexProg, const char *szFragmentProg)
{
    GLTools::gltLoadShaderPair(szVertexProg,szFragmentProg);
}

//GLuint gltLoadShaderPairWithAttributes(const char *szVertexProg, const char *szFragmentProg)
//{
//    gltLoadShaderPairWithAttributes(szVertexProg,szFragmentProg);
//}

GLuint gltLoadShaderPairSrc(const char *szVertexSrc, const char *szFragmentSrc)
{
    GLTools::gltLoadShaderPairSrc(szVertexSrc,szFragmentSrc);
}

//GLuint gltLoadShaderPairSrcWithAttributes(const char *szVertexProg, const char *szFragmentProg)
//{
//    GLTools::gltLoadShaderPairSrcWithAttributes(szVertexProg,szFragmentProg);
//}

bool gltCheckErrors(GLuint progName)
{
    GLTools::gltCheckErrors(progName);
}

void gltGenerateOrtho2DMat(GLuint width, GLuint height, M3DMatrix44f &orthoMatrix, GLBatch &screenQuad)
{
    GLTools::gltGenerateOrtho2DMat(width,height,orthoMatrix,screenQuad);
}
